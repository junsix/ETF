        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50">
              <th className="px-3 py-2 font-semibold border-b">항목</th>
              <th className="px-3 py-2 font-semibold border-b">주기</th>
              <th className="px-3 py-2 font-semibold border-b">시간</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b">
              <td className="px-3 py-2">ETF 목록</td>
              <td className="px-3 py-2">매일</td>
              <td className="px-3 py-2">07:00 KST</td>
            </tr>
            <tr className="border-b">
              <td className="px-3 py-2">일별 가격</td>
              <td className="px-3 py-2">평일</td>
              <td className="px-3 py-2">16:30 KST (장 마감 후)</td>
            </tr>
            <tr className="border-b">
              <td className="px-3 py-2">구성종목</td>
              <td className="px-3 py-2">매주 토요일</td>
              <td className="px-3 py-2">09:00 KST</td>
            </tr>
            <tr className="border-b">
              <td className="px-3 py-2">배당 데이터</td>
              <td className="px-3 py-2">매주 일요일</td>
              <td className="px-3 py-2">10:00 KST</td>
            </tr>
          </tbody>
        </table>
      </Section>
