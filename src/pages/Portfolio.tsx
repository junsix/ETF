            ...
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
                <div className={`border rounded-lg p-4 ${result.annual_return >= 0 ? "bg-red-50 border-red-200" : "bg-blue-50 border-blue-200"}`}>
                  <div className="text-xs text-gray-500 mb-1">연 수익률</div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <div className="text-xs text-gray-500 mb-1">
                    연 변동성
                    <HelpTip text="연환산 변동성 (표준편차). 수익률의 분산 정도를 나타냅니다. 낮을수록 안정적입니다." />
                  </div>
                ...
                <div className={`border rounded-lg p-4 ${sharpeBg(result.sharpe_ratio)}`}>
                  <div className="text-xs text-gray-500 mb-1">
                    샤프 비율
                    <HelpTip text="위험 대비 초과 수익률을 측정합니다. (연 수익률 - 무위험 수익률) / 연 변동성. 2.0 이상 우수, 1.0 이상 양호, 0.5 이상 보통, 0.5 미만 부진으로 평가합니다." />
                  </div>
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <div className="text-xs text-gray-500 mb-1">
                    최대 낙폭
                    <HelpTip text="MDD (Maximum Drawdown). 고점 대비 최대 하락폭입니다. 포트폴리오가 겪을 수 있는 최악의 손실 수준을 나타냅니다." />
                  </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <div className="text-xs text-gray-500 mb-1">
                    무위험 수익률
                    <HelpTip text="한국 국채 3년물 금리를 무위험 수익률로 사용합니다. 샤프 비율 계산의 기준이 됩니다." />
                  </div>
